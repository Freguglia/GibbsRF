...
RcppExport SEXP GibbsRF_Hidden_CondSample(SEXP YSEXP, SEXP XSEXP, SEXP cMatSEXP, SEXP vMatSEXP, SEXP VSEXP, SEXP GSEXP, SEXP muSEXP, SEXP sigmaSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericMatrix >::type Y(YSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"GibbsRF_Hidden_CondSample", (DL_FUNC) &GibbsRF_Hidden_CondSample, 8},
    {NULL, NULL, 0}
};
