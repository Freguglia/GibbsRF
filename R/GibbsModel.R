...
#' @param cMat a (Cx2) matrix where each line corresponds to relative position of neighbours.
#' @param V a (G+1) vector corresponding to single site potentials (from 0 to G). Must sum 0. Can be NULL if vMat is also NULL.
#' @param vMat a (Cx2G+1) matrix specifying potential values for each possible difference (from -G to G) and each type of neighbour.
